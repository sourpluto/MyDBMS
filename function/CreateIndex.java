...
public class CreateIndex {
    static public Map<String,BPlusTree> tmpMap = new HashMap<>();
    //存储所有索引B+树的list，每次进入系统都会把索引文件以B+树形式加载到内存
    static public List<Map<String,BPlusTree>> myTree_list = new ArrayList<>();
    ...
    public static void createIndex(String dbName, String tbName, String index) throws DocumentException, IOException {
        ...
        //声明一个索引id的list
        List<List<String>> index_file = new ArrayList<>();
        ...
        Map<String,BPlusTree> tmpMap = new HashMap<>();
